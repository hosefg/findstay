    ...
    <section class="ftco-section ftco-destination">
            <div class="container">
                <div class="col-md-6 pr-md-3">
                        <h2 class="mb-4"><strong>Booking</strong> Confirmation</h2>
                        <form action="/signup_traveler_post" method="POST">
                            {{ csrf_field()}}
                        <div class="form-group">
                        <input type="text" class="form-control" id="nama_depan" name="nama_depan" value="{{old('nama_depan')}}" placeholder="Nama Depan">
                            {{ $errors->first('nama_depan')}}
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="nama_belakang" name="nama_belakang" value="{{old('nama_belakang')}}" placeholder="Nama Belakang">
                            {{ $errors->first('nama_belakang')}}
                        </div>
                        <div class="form-group">
                                @if (session('status'))
                                <div class ="alert alert-failed col-md-6 pr-md-3">
                                   {{session('status')}}
                                </div>
                                @endif
                        ...
                        <div class="form-group">
                            <input type="submit" value="Sign up now" class="btn btn-primary py-3 px-5">
                        </div>
                        </form>
                      </div>
