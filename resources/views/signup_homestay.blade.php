    ...
    <section class="ftco-section ftco-destination">
            <div class="container">
                <div class="col-md-6 pr-md-">
                        ...
                        <form action="/signup_homestay" method="POST" enctype="multipart/form-data">
                            {{ csrf_field()}}
                        <div class="form-group">
                        Id Owner<input type="text" class="form-control" id="id_owner" name="id_owner" value="<?=$id_owner?>" placeholder="Nama Homestay">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="nama_homestay" name="nama_homestay" value="{{old('nama_homestay')}}" placeholder="Nama Homestay">
                            {{ $errors->first('nama_homestay')}}
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="alamat_homestay" name="alamat_homestay" value="{{old('alamat_homestay')}}" placeholder="Alamat Homestay">
                            {{ $errors->first('alamat_homestay')}}
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-control" id="harga_homestay" name="harga_homestay" value="{{old('harga_homestay')}}" placeholder="Harga homestay / hari">
                            {{ $errors->first('harga_homestay')}}
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="deskripsi_homestay" name="deskripsi_homestay" value="{{old('deskripsi_homestay')}}" placeholder="Deskripsi Homestay">
                            {{ $errors->first('deskripsi_homestay')}}
                        </div>
                        <div class="form-group">
                             Upload Photo<input type="file" class="form-control" id="foto_homestay" name="foto_homestay" value="{{old('foto_homestay')}}" placeholder="Deskripsi Homestay">
