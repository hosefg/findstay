    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="/" class="nav-link">Home</a></li>
          <li class="nav-item"><a href="{{ url('homestay') }}" class="nav-link">Homestay List</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>Explore <br></strong> your amazing Yogyakarta</h1>
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Find great homestay to stay for your holiday</p>
            <div class="block-17 my-4">
            <form action="{{url('cari')}}" method="get" class="d-block d-flex">
                <div class="fields d-block d-flex">
                  <div class="textfield-search one-third">
                  	<input type="text" class="form-control" name="search" placeholder="Ex: Find the best homestay for yourself">
                  </div>
                </div>
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                ...
                <p>We guarantee that the price and the quality is linearFFF</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">Best Homestay</h3>
                <p>We provide the best homestay at Yogyakarta</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
    				...
    				<div class="destination-slider owl-carousel ftco-animate">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					...
		    					<div class="text p-3">
		    						<h3><a href="#">Prambanan Temple</a></h3>
		    					</div>
		    				</div>
	    				</div>
	    				<div class="item">
